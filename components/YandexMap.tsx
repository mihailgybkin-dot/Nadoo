...
zoom?: number
/** показать встроенный поиск на самой карте */
showSearch?: boolean
/** колбэк на изменение области: bounds, center, zoom */
...
export default function YandexMap({ className, center, zoom = 10, showSearch = false, onBoundsChange, markers = [] }: Props) {
const apiKey = process.env.NEXT_PUBLIC_YANDEX_API_KEY
const cx = (...a: Array<string | undefined>) => a.filter(Boolean).join(' ')
return (
<div className={cx('w-full h-[360px] rounded-xl border border-neutral-200 overflow-hidden', className)}>
